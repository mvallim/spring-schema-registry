...
class AvroDeserializerTest {
  ...
  @Test
  void testSuccessDeserializer() throws IOException {
  ...
  @Test
  void testSuccessDeserializerNullData() throws IOException {
    final RecordHeaders headers = new RecordHeaders();
  ...
  @Test
  void testSuccessDeserializerRiseSerializationException() throws IOException {
  ...
  @Test
  void testSuccessDeserializerRiseUnsupportedOperationException() throws IOException {
